...
class animalModel(nn.Module):
    def __init__(self):
        ...
        model = resnet34()
        model.load_state_dict(torch.load('../checkpoints/0222cifar10originResNet2.pkl'))
    ...
    def forward(self, x):
        ...
        return out
# %%
logging.basicConfig(level=logging.DEBUG, filename='../log/0222animaloriginResNet.log',
...
def main():
    ...
    #save model weight
    torch.save(model.state_dict(), '../checkpoints/animaloriginResNet2.pkl')
