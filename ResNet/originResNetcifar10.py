...
# %%
logging.basicConfig(level=logging.DEBUG, filename='../log/0227cifar10fintuneoriginResNet.log',
...
class animalModel(nn.Module):
    def __init__(self):
        ...
        model.load_state_dict(torch.load('../checkpoints/0226cifar10originResNxet2.pkl'))
...
# %%
train_data = makedataset('/home/bear/dl/animal.csv', 'train', trans)
test_data = makedataset('/home/bear/dl/animal.csv', 'val', trans_test)
# %%
...
def main():
    ...
    #save model weight
    torch.save(model.state_dict(), '../checkpoints/0222cifar10originResNet2.pkl')
